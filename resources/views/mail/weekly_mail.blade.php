                          ...
                          <td>
                            ...
                            <tr>
                              <td align="center" style="padding:20px 0;">
                                <center>
                                    <iframe class = "col-xs-12 form-control" frameborder="0" allowfullscreen src="{{$video}}"></iframe>
                                </center>
                              </td>
                            </tr>
                            @endif
                            <tr>
                                <td align="center" style="padding:20px 0;">
                                    You deposited {{$weekly_count}} coins this week.
                                    The weekly goal is {{$weekly_goal}}.
                                </td>
                            </tr>
                          </table>
                          </td>
